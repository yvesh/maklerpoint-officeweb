...
<div id="waehrungen_menu">
	<div id="waehrungen_control_menu" class="ui-widget-header ui-corner-all">
		<span id="toolbar">
			...
			<button id="btnDeleteWaehrung">Löschen</button> | 
...
<div id="dialog_delete" title="Wirklich löschen?">
	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Wollen Sie die Währung(en) wirklich löschen?</p>
</div>
<div id="dialog_archive" title="Wirklich archivieren?">
	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Wollen Sie die Währung(en) wirklich archivieren?</p>
</div>
